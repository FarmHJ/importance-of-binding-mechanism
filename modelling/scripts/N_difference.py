...
#     plt.plot(N_range, RMSD_arr)
    ...
    drug_RMSD = drug_df.loc[drug_df[('drug', 'drug')] == drug][('RMSE', 'RMSE')].values
    ...
    delta_RMSD_df = pd.DataFrame(
        ...
        index=['drug', 'deltaRMSD_min', 'deltaRMSD_max', 'deltaRMSD_mean',
               'deltaRMSD_ratio_min', 'deltaRMSD_ratio_max', 'deltaRMSD_ratio_mean'])
...
plt.savefig('../../figures/sensitivity_analysis/N/APD90_diff.pdf', bbox_inches='tight')
