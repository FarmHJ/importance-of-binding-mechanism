...
def param_evaluation(param, param_values):
    ...
    Hill_curve_coefs, drug_conc_Hill, peaks_norm = \
        ComparisonController.compute_Hill(drug_model, parallel=True)
    ...
    drug_conc_AP = [i / norm_constant for i in drug_conc_AP]
        ...
        try:
            APD_trapping, APD_conductance, drug_conc_AP = \
                ComparisonController.APD_sim(
                    ...
                    EAD=True, norm_constant=norm_constant)
    ...
    return big_df, APD_trapping, APD_conductance, drug_conc_AP
...
for drug in drug_list:
    ...
    #     param_evaluation(param, 'dofetilide', param_values)
    big_df, APD_trapping, APD_conductance, drug_conc_AP = \
        param_evaluation(Hill_n, param_values)

    plt.figure()
    plt.plot(drug_conc_AP, APD_trapping, 'o')
    plt.plot(drug_conc_AP, APD_conductance, '^')
    plt.xscale('log')
    plt.savefig('../../figures/testing/dofetilide_APD_check.pdf')
